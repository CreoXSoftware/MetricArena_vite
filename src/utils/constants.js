...
export const PLAYER_COMPARISON_ROWS = [
  ...
  { label: 'Avg Speed',     bestKey: 'best_avgspeed',    avgKey: 'avg_avgspeed',    unit: 'm/s',  fmt: v => (v / 3.6).toFixed(2) },
...
export const TEAM_COMPARISON_ROWS = [
  ...
  { label: 'Avg Speed',     key: 'avg_avgspeed',      unit: 'm/s',  fmt: v => (v / 3.6).toFixed(2) },
